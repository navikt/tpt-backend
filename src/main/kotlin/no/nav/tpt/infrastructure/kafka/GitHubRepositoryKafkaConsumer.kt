        ...
        try {
            ...
            scope.launch(Dispatchers.IO) {
                try {
                    ...
                    logger.info("Successfully upserted GitHub repository data for: ${message.repositoryName}")
                } catch (e: Exception) {
                    logger.error("Error upserting GitHub repository data for ${message.repositoryName}", e)
                }
            }
        } catch (e: Exception) {
